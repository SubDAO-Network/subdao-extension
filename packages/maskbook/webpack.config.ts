    ...
    const config: Configuration = {
        ...
        resolve: {
            ...
            alias: {
                ...
                '@subdao/icons': require.resolve('../icons/index.ts'),
                '@subdao/maskbook-shared': require.resolve('../shared/src/index.ts'),
                '@subdao/maskbook-theme': require.resolve('../theme/src/theme.ts'),
...
export default async function (cli_env: Record<string, boolean> = {}, argv: { mode?: 'production' | 'development' }) {
    ...
    function getBuildNotificationPlugins() {
        ...
        const opt = { title: 'SubDAO', excludeWarnings: true, skipFirstNotification: true, skipSuccessful: true }
