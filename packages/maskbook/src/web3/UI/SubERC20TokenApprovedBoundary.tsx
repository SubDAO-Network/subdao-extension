...
import { ApproveStateType, useSubERC20TokenApproveCallback } from '../hooks/useSubERC20TokenApproveCallback'
...
export interface SubERC20TokenApprovedBoundaryProps {
    amount: string
    spender: string
...
export function SubERC20TokenApprovedBoundary(props: SubERC20TokenApprovedBoundaryProps) {
    ...
    ] = useSubERC20TokenApproveCallback(token?.address ?? '', amount, spender)

    console.log(`approveStateType...`, approveStateType)
