...
import { flagChart } from '../../crypto/constants'
...
export const twitterEncoding = {
    ...
    payloadEncoder: (text: string) =>
        `https://www.subdao.network/?post_v1=${batchReplace(text, [
            [flagChart, '%50'],
            [':||', '%90'],
            ['+', '-'],
            ['=', '_'],
