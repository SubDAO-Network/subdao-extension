...
const db = createDBAccess(() => {
    return openDB<GroupDB>('subdao-user-groups', 1, {
...
/**
 * Delete a user group that stored in the SubDAO
...
/**
 * Update a user group that stored in the SubDAO
 * @param group Group ID
 * @param type
 */
...
/**
 * Query a user group that stored in the SubDAO
 * @param group Group ID
 */
...
/**
 * Query user groups that stored in the SubDAO
