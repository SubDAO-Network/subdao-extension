...
export default function ProfileBox({ persona, ProviderLineProps, border }: ProfileBoxProps) {
    ...
    const providers = [...definedSocialNetworkUIs.values()]
        ...
        .filter((x) => x && x.internalName !== 'instagram.com' && x.internalName !== 'facebook.com')
