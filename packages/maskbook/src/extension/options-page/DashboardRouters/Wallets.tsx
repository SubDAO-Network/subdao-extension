...
import { usePolkadotTokenBalance } from '../../../polkadot/hooks/usePolkadotTokenBalance'
...
export const DashboardWalletsContext = createContext<{
    detailedToken: TokenDetailedType
...
export default function DashboardWalletsRouter() {
    ...
    const [walletCreate, openWalletCreate] = useModal(WalletCreateDialog)
    ...
    return (
        <DashboardWalletsContext.Provider value={{ detailedToken, detailedTokensLoading, detailedTokensRetry }}>
