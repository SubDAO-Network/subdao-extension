...
import { deconstructPayload, PayloadAlpha20 } from '../../../utils/type-transform/Payload'
...
export function DecryptedPostDebug(props: Partial<DebugDisplayProps>) {
    ...
    const ownersAESKeyEncrypted = payload.AESKeyEncrypted ?? payload.ownersAESKeyEncrypted
    return (
        <DebugList
            items={[
                postBy.equals(whoAmI) ? postByMyself : (['Hash of this post', debugHash] as const),
                ...
                ['sharedPublic (v20)', (payload as PayloadAlpha20).sharedPublic],
                ['authorPublicKey (v20)', (payload as PayloadAlpha20).authorPublicKey],
            ]}
        />
    )
}
