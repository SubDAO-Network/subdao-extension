...
import type { PayloadAlpha20 } from '../../utils/type-transform/Payload'
            ...
            <DecryptPostX
                ...
                requestAppendRecipients={
                    ...
                    (encryptedPost.ok && encryptedPost.val.version !== -40) || decryptedPayloadForImage
                        ? async (profile) => {
                              const val = (postImages ? decryptedPayloadForImage : encryptedPost.val) as PayloadAlpha20

                              const { iv, version } = val
                              const ownersAESKeyEncrypted = val.AESKeyEncrypted ?? val.ownersAESKeyEncrypted
