    ...
    return (
        <InjectedDialog onClose={props.onClose} open={open} title="Troubleshoot">
            <DialogContent>
                ...
                <DialogContentText>
                    The "Magic Code" and the Fingerprint should be the same on your friend's SubDAO and your SubDAO.
                </DialogContentText>
                <DialogContentText>
                    If Fingerprint is not the same, it means at least one of SubDAO doesn't get the correct key of the
                    receiver.
                </DialogContentText>
                <DialogContentText>
                    If MagicCode is not the same, it means at least one of SubDAO calculate the post hash wrong.
                </DialogContentText>
                <List dense>
